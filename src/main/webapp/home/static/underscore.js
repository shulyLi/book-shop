...
//解码的方法
    ...
    (function () {
        ...
        /**
         * 获取GPS信息
         * @param callback 回调函数，参数详见Native Api文档
         */
    ...
    (function () {
        ...
        function noEmoji(elem) {
            if ((/[^0-9^a-z^A-Z^\u4E00-\u9FA5^！!?？.。,，、<>《》￥’”“【】{}（）=()-_‘’]+$/).test(elem.value)) {
                elem.value = elem.value.replace(/[^0-9^a-z^A-Z^\u4E00-\u9FA5^！!?？.。,，、<>《》￥’”“【】{}（）=()-_‘’]*/g, '');
            }
            return true;
        }
        _.extend(_, {
